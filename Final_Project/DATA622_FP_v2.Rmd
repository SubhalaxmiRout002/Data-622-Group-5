...
for (i in k_range) {
  #  Unscaled data
  set.seed(26)
  train_pred_a <- knn(train, test, trainingtarget_knn, k=i)
  ...
  # Standard Scaling
  set.seed(26)
  train_pred <- knn(training_knn, testing_knn, trainingtarget_knn, k=i)
...
```{r}
set.seed(26)
train_pred <- knn(train, test, trainingtarget_knn, k=acc)
