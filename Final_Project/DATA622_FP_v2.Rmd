...
# created 4 datasets for LR, Neural nets, NN using keras, kNN
loan_new2 <- loan
loan_nn <- loan
loan_keras <- loan
loan_knn <- loan
...
This model has high accuracy, but this is not a good model for predict loan approve No category. This model predict 100% accuract for Yes category, but this is not a recommended model to use. 
