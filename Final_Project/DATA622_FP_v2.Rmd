...
This model includes 2 variables such as TotalIncome and Credit_History.
...
Accuracy improved from 66% to 70%. The model has 23 misclassification, the model is predict good performance for suicide class. However showing poor performace for no suicide class. 
