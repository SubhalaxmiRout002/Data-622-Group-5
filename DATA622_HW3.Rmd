...
* Remove Gender, Married, Self_Employed variables from data, because loan approval does not depend on gender or marital status or self occupy business or not
* Change variables  Education and Property_Area from Categorical to numeric 
  
  + Education: Graduate = 2 and Not Graduate = 1
...
loan_new <- subset(loan, select = -c (Gender, Married, Self_Employed))
...
loan_new$Education <- ifelse(loan_new$Education=="Graduate", 2, 1)
if(loan_new$Property_Area=="Semiurban")
  {
    loan_new$Property_Area <- 3
...
* Train dataset accuracy : `r (1 - 0.193) * 100`, error rate: `r 0.193 * 100`
* Test dataset accuracy : `r (1 - 0.162) * 100`, error rate:`r 0.162 * 100`
...
```{r}
# Subha : WOrking on Random forest
#Create the forest
