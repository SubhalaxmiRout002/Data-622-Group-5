...
#### Confusion matrix for `SVM_Model_1` and `SVM_Model_2`
...
#### Confusion matrix for `SVM_Model_3`
...
## SVM: Entire dataset and general dataset using PCA output
...
#### Confusion matrix for `SVM_Model_4`
...
#### Confusion matrix for `SVM_Model_5`
...
#### Confusion matrix for `SVM_Model_6`
...
#### Confusion matrix for `SVM_Model_7`
...
#### Confusion matrix for `SVM_Model_8`
...
#### Confusion matrix for `SVM_Model_9`
...
We performed total 9 models using SVM, the genl dataset without PCA gave better result than the PCA model with genl data. But the entire dataset model performed better in comparision to other models. Above all the models, `SVM_Model_4` is the best model. 
